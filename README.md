...
- многостраничный статический сайт: `index.html`, `project-manager.html`, `ai-developer-intern.html`
- данные страниц: `app.js`, `ai-developer-intern.js`
- исходные сообщения: `input/messages.md`
- основной датасет: `input/messages.csv`
- бриф для AI-стажера: `input/ai-developer-brief.md`
