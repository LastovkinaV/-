...
Внутри этой папки можно держать несколько `html`-страниц. Главная страница
`index.html` работает как каталог ролей, а остальные страницы можно открывать
по прямым ссылкам внутри того же сайта.
